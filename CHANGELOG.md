...
- `manifest.yaml` backend range separator normalized from comma (`">=20.10,<27.0"`) to space (`">=20.10 <27.0"`) — matches the semver ecosystem convention used by npm, cargo, bundler, and the mgtt v1.0 schema spec example. Semantics unchanged.
